...
public class InstanceofTest {
	...
	public static void main(String[] args) {
		...
		System.out.printf("name = %s 이며%n" + "%s은(는) String 타입인가? %b%n", name, name, result);
		...
		// 2. 초기화
		surname = new StringBuffer("Gang");
		
		// 3. 사용
		result = ((Object)surname instanceof String);
		System.out.printf("surname = %s 이며%n" + "%s은(는) String 타입인가? %b%n", surname, surname, result);
